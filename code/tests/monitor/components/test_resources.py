...
from agent.monitor.components.resources import ResourcesMonitor
from agent.monitor.data.resources_data import ResourcesData, DiskDataStructure, \
...
class TestResourcesMonitor(unittest.TestCase):
    ...
    @patch('agent.monitor.components.resources.execute_cmd')
