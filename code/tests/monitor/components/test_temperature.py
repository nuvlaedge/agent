...
import agent.monitor.components.temperature
from agent.monitor.components.temperature import TemperatureMonitor
...
class TestTemperatureMonitor(unittest.TestCase):
    ...
    def test_update_temperature_entry(self):
        ...
        self.assertIn('cpu', test_monitor.data.temperatures)
        self.assertIsInstance(test_monitor.data.temperatures['cpu'], TemperatureZone)

    @patch('agent.monitor.components.temperature.psutil')
    @patch('agent.monitor.components.temperature.TemperatureMonitor.'
    ...
    def test_read_temperature_file(self):
        ...
        with patch('agent.monitor.components.temperature.open', mock_open(read_data=None)):
        ...
        with patch('agent.monitor.components.temperature.open',
    ...
    def test_update_temperatures_with_file(self, mock_exists, mock_listdir,
        ...
        test_monitor.update_temperatures_with_file()
        self.assertEqual(test_monitor.data.temperatures['metric'].dict(by_alias=True),
                         expected_output[0],
