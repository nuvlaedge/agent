...
from agent.monitor.components.gpio import GpioMonitor
...
class TestGpioMonitor(unittest.TestCase):
    ...
    def get_base_monitor() -> GpioMonitor:
        ...
        with patch('agent.monitor.components.gpio.execute_cmd') as mock_cmd:
            mock_cmd.return_value = True
            return GpioMonitor('test_monitor', mock_telemetry, True)

    @patch('agent.monitor.components.gpio.GpioMonitor.gpio_availability')
    ...
    @patch('agent.monitor.components.gpio.execute_cmd')
    ...
    @patch('agent.monitor.components.gpio.GpioMonitor.parse_pin_cell')
