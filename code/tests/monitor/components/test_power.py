...
import agent.monitor.components.power
from agent.monitor.components.power import PowerMonitor
...
class TestPowerMonitor(unittest.TestCase):
    ...
    @patch('agent.monitor.components.power.PowerMonitor.get_power')
